    ...
    <div className="p-8">
          ...
          <div className="lg:flex items-center gap-3">
            ...
            >
              ...
              <div className="lg:flex gap-3">
                <div className="flex items-center sm:max-lg:mt-3 gap-3 hidden min-[900px]:flex">
                  <Filter
                    changeKeyword={changeKeyword}
                    keyword={keyword}
                    filterLeads={filterData}
      ...
      <div className="mt-8">
        ...
        <AdvancedTable
          ...
          minCellWidth={100}
          emptyStateProps={{
            attachment: <TeamInfo isCompanyDetailsHidden={true} />,
            attachmentCondition: user.agent.team?.teamName !== "",
