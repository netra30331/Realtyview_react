...
const View = (props: IProps) => {
    const initialLead: ILead = {
        ...
        buyerCoolingTypeMulti: props.data?.buyerCooling ?? [],
        ...
        buyerPreApprovalIssueDate: props.data?.buyerPreApprovalIssueDate ?? undefined,
        buyerPreApprovalExpirationDate: props.data?.buyerPreApprovalExpirationDate ?? undefined,
        ...
        sellerIsPreForeclosure: props.data?.landlordKeywords ?? 'No',
        about: props.data?.about ?? '',
        lastContact: props.data?.lastContact ?? undefined,
        nextContact: props.data?.nextContact ?? undefined,
        startOfTarget: props.data?.startOfTarget ?? undefined,
        endOfTarget: props.data?.endOfTarget ?? undefined,
